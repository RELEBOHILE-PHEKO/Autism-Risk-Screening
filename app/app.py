...
st.set_page_config(
    page_title="CheckME | Autism Risk Screening",
    page_icon=None,
    layout="wide",
...
def render_overview():
    ...
    <div class="hero">
        ...
        <div class="hero-title">CheckME — Early ASD Risk Screening for <em>Southern Africa</em></div>
        <p class="hero-sub">
            CheckME estimates a child's likelihood of autism spectrum risk from a short caregiver
    ...
    st.markdown("### What makes CheckME different")
    st.markdown("""
    ...
    st.markdown("### What CheckME can — and cannot — do")
    st.markdown("""
